...
*** Ominaisuuksia
    -paikallisia muuttujia käpistelee vain yksi monitorin metodit
    -monitoriin pääsee kutsumalla jotain sen metodia
    -vain yksi prosessi on kerrallaan monitorissa
*** sykronisaatio hoidetaan muuttujilla (condition variables)
*** cwait(c) suspendaa 
     Aina asettaa kutsujan suspended tilaan ja jonoon
     avaa monitorin mutextin, joku muu pääsee monitoriin
     kun awakened, odottaa muteksia lukkiutumaan ja jatkamaan
*** csignal(c) jatkaa jotain odottavista prosesseista
     - herättää ekan odottavan prosessin jonosta
*** Osa signalling featureista ei täällä!
** Mailbox
